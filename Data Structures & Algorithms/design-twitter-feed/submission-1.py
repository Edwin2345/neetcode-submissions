class Twitter:
    ...
    #Profile will be a class with list of own tweets (time, tweetid) (max-heap) and list of followers (user ids)
    ...
    def postTweet(self, userId: int, tweetId: int) -> None:
        ...
        #push on timestamped tweet into users tweet
        heapq.heappush(self.userProfiles[userId].tweets, (self.tweetTimestamp, tweetId))
    ...
    def getNewsFeed(self, userId: int) -> List[int]:
        ...
        #run heapfiy and take the top ten tweets only -> O(Nlog(10))
        newestTweets = heapq.nsmallest(10, releventTweets)
        return [ t[1] for t in newestTweets ] 
